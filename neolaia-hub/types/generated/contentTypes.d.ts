...
export interface ApiNeolaiaUserNeolaiaUser extends Schema.CollectionType {
  collectionName: 'neolaia_users';
  info: {
    singularName: 'neolaia-user';
    pluralName: 'neolaia-users';
    displayName: 'neolaia-user';
    description: '';
  };
  options: {
    draftAndPublish: false;
...
export interface ApiResearchInfoSurveyResearchInfoSurvey
  extends Schema.CollectionType {
  collectionName: 'research_info_surveys';
  info: {
    singularName: 'research-info-survey';
    pluralName: 'research-info-surveys';
    displayName: 'researchInfoSurvey';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    free_keyword_3: Attribute.Text;
    university_name: Attribute.String & Attribute.Required;
    department: Attribute.Text & Attribute.Required;
    faculty: Attribute.Text;
    ERC_Panel_1: Attribute.Text & Attribute.Required;
    ERC_Panel_2: Attribute.Text;
    ERC_Panel_3: Attribute.Text;
    ERC_Keyword_1: Attribute.Text & Attribute.Required;
    ERC_Keyword_2: Attribute.Text;
    ERC_Keyword_3: Attribute.Text;
    ...
    research_units_tours: Attribute.Text;
    specific_research_units_tours: Attribute.Text;
    free_keyword_4: Attribute.Text;
